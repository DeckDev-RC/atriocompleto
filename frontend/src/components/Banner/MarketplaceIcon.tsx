    ...
    case 'bagy':
      return (
        <div className={iconBase}>
          <img src={bagyImg} alt="Bagy" className="h-full w-full object-cover" width={32} height={32} loading="lazy" decoding="async" />
        </div>
      );
    case 'shopee':
      return (
        <div className={iconBase}>
          <img src={shopeeImg} alt="Shopee" className="h-full w-full object-cover" width={32} height={32} loading="lazy" decoding="async" />
        </div>
      );
    case 'shein':
      return (
        <div className={iconBase}>
          <div className="h-[80%] w-[80%] bg-white rounded-lg overflow-hidden flex items-center justify-center">
            <img src={sheinImg} alt="Shein" className="h-full w-full object-contain" width={26} height={26} loading="lazy" decoding="async" />
          </div>
        </div>
      );
    case 'ml':
      return (
        <div className={iconBaseLarge}>
          <div className="bg-white rounded-lg h-[80%] w-[80%] overflow-hidden flex items-center justify-center">
            <img src={mlImg} alt="Mercado Livre" className="h-full w-full object-contain" width={32} height={32} loading="lazy" decoding="async" />
          </div>
        </div>
      );
    case 'ambro':
      return (
        <div className={iconBase}>
          <img src={ambroImg} alt="Ambro" className="h-full w-full object-cover" width={32} height={32} loading="lazy" decoding="async" />
        </div>
      );
    case 'store':
      return (
