...
/**
 * Route wrapper that checks for authentication, permissions, and feature flags.
...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
    ...
    const { isAuthenticated, isLoading, isMaster, hasPermission, hasFeature } = useAuth();
        ...
        return (
            <div className="flex min-h-[60vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4 text-center max-w-sm px-6">
                    ...
                    <h2 className="text-lg font-semibold text-primary">Funcionalidade Indisponível</h2>
                    <p className="text-[13px] text-muted leading-relaxed">
                        Esta funcionalidade não está habilitada para sua empresa.
