...
import { Camera, Trash2, Loader2, Pencil, Check, X, ShieldCheck } from 'lucide-react';
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="mt-4 border-t border-border/40 pt-6">
        <div className="rounded-2xl border border-border bg-card/60 p-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-border/60 bg-primary/5">
              <ShieldCheck size={18} className="text-muted" />
            </div>
            <div>
              <p className="text-[14px] font-semibold text-primary">Autenticacao em duas etapas</p>
              <p className="text-[12px] text-muted">
                O 2FA foi desabilitado globalmente nesta plataforma.
              </p>
            </div>
          </div>
        </div>
